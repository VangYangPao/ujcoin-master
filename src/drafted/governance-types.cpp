...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZulaNetwork") type = ZulaNetwork;
    if(strType == "ZulaNetworkVariable") type = ZulaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZulaNetwork) s = "ZulaNetwork";
    if(type == ZulaNetworkVariable) s = "ZulaNetworkVariable";
