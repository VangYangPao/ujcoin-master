 ...
 *
 *   // network
 *   CZulaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zula.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZulaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ZulaNetwork
// //   -- signature requirements : Key1(User)
// class CZulaNetworkVariable : public CGovernanceObject
// {
// private:
