    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Zula Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zula address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zula: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Zula Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zula Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zula Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zula addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zula addresses"));
    ...
    openAction->setStatusTip(tr("Open a zula: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zula Core help message to get a list with possible Zula Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zula Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zula network", "", count));
    } else {
...
{
    QString strTitle = tr("Zula Core"); // default title
