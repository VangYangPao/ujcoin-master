    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Zula-light"), QVariant("light"));
/*    ui->theme->addItem(QString("Zula-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("Zula-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("Zula-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("Zula-traditional"), QVariant("trad"));
*/    
    /* Language selector */
