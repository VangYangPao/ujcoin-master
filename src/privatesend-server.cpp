...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Zula related functionality
...
/*
    ...
    allow endless transaction that would bloat Zula and make it unusable. To
