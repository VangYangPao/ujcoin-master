...
This mechanism has been integrated into Bitcore-Node-Zula which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zulapay/insight-api-zula#web-socket-api](https://github.com/zulapay/insight-api-zula#web-socket-api)
* API: [https://github.com/zulapay/insight-api-zula#instantsend-transactions](https://github.com/zulapay/insight-api-zula#instantsend-transactions)
...
By default, the Zula Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zula Core daemon:
