...
Only requiring some minor changes is zula.cpp.
...
Changes to zula.cpp
----------------------
zula.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
