...
Zula Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 13881.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 13880 for connections and services them.
...
However, in open source software such as Zula Core, where everyone uses
...
pay attention to for reviewers of Zula Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zula Core uses tinyformat, which is type safe. Leave them out to avoid confusion
